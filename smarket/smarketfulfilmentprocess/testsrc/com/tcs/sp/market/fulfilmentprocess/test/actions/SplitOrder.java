 ...
 *
 */
package com.tcs.sp.market.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(SmarketFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SmarketFulfilmentProcessConstants.PARENT_PROCESS);
