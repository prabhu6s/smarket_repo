 ...
 *
 */
package com.tcs.sp.market.cockpits.setup;
...
import com.tcs.sp.market.cockpits.constants.SmarketCockpitsConstants;
 ...
 */
@SystemSetup(extension = SmarketCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(SmarketCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(SmarketCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						SmarketCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/smarketcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
