 ...
 *
 */
package com.tcs.sp.market.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("smarketcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("smarketcockpits.product.externalTaxes"));
