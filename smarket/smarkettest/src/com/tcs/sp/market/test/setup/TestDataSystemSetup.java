 ...
 *
 */
package com.tcs.sp.market.test.setup;
...
import com.tcs.sp.market.test.constants.SmarketTestConstants;
import com.tcs.sp.market.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = SmarketTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/smarkettest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/smarkettest/import/reviews.impex");
			...
			importImpexFile(context, "/smarkettest/import/cstickets.impex");
		}
	}
}
