 ...
 *
 */
package com.tcs.sp.market.core.hmc;
...
/**
 * Provides necessary meta information about the smarketcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class SmarketCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SmarketCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.tcs.sp.market.core.hmc.locales";
