 ...
 * 
 */
package com.tcs.facetvalue.boost.hmc;
 ...
 * 
 */
public class FacetValueBoostingHMCExtension extends HMCExtension
{

	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(FacetValueBoostingHMCExtension.class.getName());
