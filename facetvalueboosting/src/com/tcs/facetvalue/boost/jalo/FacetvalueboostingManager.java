...
/**
 * This is the extension manager of the Facetvalueboosting extension.
 */
public class FacetvalueboostingManager extends GeneratedFacetvalueboostingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(FacetvalueboostingManager.class.getName());
	 ...
	 */
	public static FacetvalueboostingManager getInstance()
	{
		return (FacetvalueboostingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				FacetvalueboostingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public FacetvalueboostingManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of FacetvalueboostingManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of FacetvalueboostingManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of FacetvalueboostingManager called, current tenant: " + getTenant().getTenantID());
		}
	}
